...
WebUI.delay(2)
WebUI.executeJavaScript(GlobalVariable.btnInhabilitarGeneral, [])
WebUI.delay(2)
WebUI.executeJavaScript(GlobalVariable.btnDesabilitarGeneral, [])
WebUI.delay(2)
WebUI.acceptAlert()
WebUI.delay(10)
//Activar de nuevo el registro para continuar el ciclo...
WebUI.executeJavaScript(GlobalVariable.inputItem, [])
WebUI.delay(2)
WebUI.executeJavaScript(GlobalVariable.btnEditarGeneralPrueba, [])
WebUI.delay(2)
WebUI.executeJavaScript(GlobalVariable.checkActivarGeneral, [])
WebUI.delay(2)
