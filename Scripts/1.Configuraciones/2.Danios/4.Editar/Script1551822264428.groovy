...
WebUI.setText(findTestObject('1.Configuracion/2.Danios/Editar/inputNombre'), 'Ejecutando la edicion del registro...')

WebUI.delay(2)

WebUI.setText(findTestObject('1.Configuracion/2.Danios/Editar/textareaDescripcion'), 'Execute para Universitarios...')
