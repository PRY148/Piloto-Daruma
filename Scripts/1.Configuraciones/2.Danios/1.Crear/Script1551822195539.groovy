...
WebUI.executeJavaScript(GlobalVariable.clickBtn2, [])

WebUI.delay(2)

WebUI.navigateToUrl('http://54.203.130.100:8106/app_mysql.php/event_injury?related_module=event')
...
WebUI.setText(findTestObject('1.Configuracion/2.Danios/Crear/inputNombre'), 'Ejecutando una nueva prueba')

WebUI.delay(2)

WebUI.setText(findTestObject('1.Configuracion/2.Danios/Crear/textareaDescripcion'), 'Ejecucion Maestra...')
