...
WebUI.executeJavaScript(GlobalVariable.clickBtn7, [])

WebUI.delay(2)

WebUI.navigateToUrl('http://54.203.130.100:8106/app_mysql.php/accident_agent?related_module=event')
...
WebUI.setText(findTestObject('1.Configuracion/7.Agente del Accidente/1.Crear/inputNombre'), 'Ejecutando una nueva prueba')

WebUI.delay(2)

WebUI.setText(findTestObject('1.Configuracion/7.Agente del Accidente/1.Crear/textareaDescripcion'), 'Ejecucion Maestra...')
