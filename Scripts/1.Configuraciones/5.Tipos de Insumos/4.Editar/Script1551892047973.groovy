...
WebUI.setText(findTestObject('1.Configuracion/5.Tipos de Insumos/2.Editar/inputNombre'), 'Editando ando...')

WebUI.delay(2)

WebUI.setText(findTestObject('1.Configuracion/5.Tipos de Insumos/2.Editar/textareaDescripcion'), 'Setear a un textarea...')

WebUI.delay(2)

WebUI.click(findTestObject('1.Configuracion/5.Tipos de Insumos/2.Editar/inputSelectClasificacion'))
